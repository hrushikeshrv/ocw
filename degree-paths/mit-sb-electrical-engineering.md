# MIT Curriculum for BS in Electrical Engineering with Computing (2025)
[https://eecsis.mit.edu/degree_requirements.pcgi?program=6-5_2025](https://eecsis.mit.edu/degree_requirements.pcgi?program=6-5_2025)

Course codes below are in the format `NEW_CODE [OLD_CODE]`. Most OCW/YouTube links are for old codes.

**Four fundamental subjects**
- [x] 6.1000 [6.0001] Introduction to Programming and Computer Science ([OCW Link](https://ocw.mit.edu/courses/6-0001-introduction-to-computer-science-and-programming-in-python-fall-2016/))
- [x] 6.1200 [6.042] Mathematics for Computer Science ([OCW Link](https://ocw.mit.edu/courses/6-042j-mathematics-for-computer-science-spring-2015/))
- [x] 6.1210 [6.006] Introduction to Algorithms ([OCW Link](https://ocw.mit.edu/courses/6-006-introduction-to-algorithms-spring-2020/))
